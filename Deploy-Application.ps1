...
Try {
	...
	[string]$appName = 'Simulation Mechanical'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'acad, algframe' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\Img\Setup.exe" -Parameters '/W /Q /I SimulationMechanical2017' -WindowStyle 'Hidden' -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'acad, algframe' -CloseAppsCountdown 60
        ...
        # Uninstall Autodesk Simulation Job Manager
        Execute-MSI -Action Uninstall -Path '{07E9A378-0064-0600-0221-3B818631FADF}'
        # Autodesk Simulation Mechanical 2017
        Execute-MSI -Action Uninstall -Path '{9C323B87-596F-2017-B164-A8E126A75E02}'
